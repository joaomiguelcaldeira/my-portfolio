...
from search import Problem, Node, astar_search, breadth_first_tree_search, \
	depth_first_tree_search, greedy_search,iterative_deepening_search,recursive_best_first_search
import sys
...
class RicochetRobots(Problem):
	...
	def h(self, node: Node):
		...
		cordRobotAlvo = node.state.board.boardRobots[corAlvo]
		posAlvo = getPos(cordRobotAlvo[0],cordRobotAlvo[1],node.state.board.size)
		return self.heuristicNodes[posAlvo]
